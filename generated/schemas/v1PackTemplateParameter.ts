 ...
 */
import type { V1PackTemplateParameterOptions } from './v1PackTemplateParameterOptions';

/**
 * Pack template parameter
 */
export interface V1PackTemplateParameter {
  ...
  options?: V1PackTemplateParameterOptions;
