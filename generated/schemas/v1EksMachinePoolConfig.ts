...
export interface V1EksMachinePoolConfig {
  /** additionalLabels */
  additionalLabels?: V1EksMachinePoolConfigAdditionalLabels;
  /** AdditionalTags is an optional set of tags to add to resources managed by the provider, in addition to the ones added by default. For eg., tags for EKS nodeGroup or EKS NodegroupIAMRole */
  additionalTags?: V1EksMachinePoolConfigAdditionalTags;
  /** ami type */
  amiType?: string;
  ...
  capacityType?: V1EksMachinePoolConfigCapacityType;
  ...
  subnetIds?: V1EksMachinePoolConfigSubnetIds;
